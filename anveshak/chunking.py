"""Utilities for splitting long text into overlap-aware retrieval chunks."""
...
class TextChunk:
    """One retrieval-ready slice of a larger source document."""
...
def chunk_text(
    ...
    *,
    ...
    """Split text into deterministic, slightly overlapping retrieval chunks."""
