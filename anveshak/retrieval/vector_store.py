"""Tiny persistent FAISS wrapper used by workspace, web, and memory retrieval."""
...
class PersistentFaissStore:
    """Persist a cosine-similarity FAISS index alongside JSON metadata."""
    ...
    def _load(self) -> None:
        """Restore a previously saved FAISS index and metadata payload."""
    ...
    def _ensure_index(self, dimension: int) -> None:
        """Create the underlying FAISS index lazily once the dimension is known."""
    ...
    def save(self) -> None:
        """Write the FAISS index and its metadata sidecar to disk."""
    ...
    def reset(self) -> None:
        """Delete all persisted index state and start from a blank store."""
