"""Active web search and indexing helpers used during live retrieval."""
...
class WebIndexer:
    """Fetch, chunk, embed, and rank web pages for a given search query."""
    ...
    def search_and_retrieve(self, query: str, top_k: int) -> list[RetrievedChunk]:
        """Run a search query and return ranked web chunks ready for prompting."""
    ...
    def _search_results(self, query: str) -> list[dict[str, Any]]:
        """Fetch search results with caching and light retries so repeated runs stay stable."""
